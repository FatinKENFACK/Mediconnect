...
const NewAppointment = () => {
  ...
  const location = useLocation(); // ⬅️ NOUVEAU : donne accès au "state" transmis par navigate()
  ...
  // ============================================================
  // ⬇️ NOUVEAU : médecin déjà présélectionné (ex: depuis le modal
  // "médecins alternatifs" quand un RDV n'était pas confirmé).
  // Si présent, on saute directement à l'étape 2 sans repasser
  // par le choix du médecin.
  // ============================================================
  useEffect(() => {
    if (location.state?.preselectedDoctor) {
      setSelectedDoctor(location.state.preselectedDoctor);
      setStep(2);
    }
  }, [location.state]);
                      ...
                      <div className="pl-4 border-l-2 border-blue-200 space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <button
                            ...
                            className={`flex items-center justify-center gap-2 py-3 px-3 rounded-lg border-2 text-sm font-medium transition-colors ${preferredCallType === 'video'
                          ...
                          <button
                            ...
                            className={`flex items-center justify-center gap-2 py-3 px-3 rounded-lg border-2 text-sm font-medium transition-colors ${preferredCallType === 'audio'
