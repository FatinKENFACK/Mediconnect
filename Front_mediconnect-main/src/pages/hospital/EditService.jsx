    ...
    const loadService = async () => {
      try {
        ...
        const mockService = {
          ...
          description: 'Consultation spécialisée en cardiologie pour le diagnostic et le traitement des maladies cardiovasculaires. Nos cardiologues expérimentés utilisent les technologies les plus récentes pour assurer des soins de qualité.',
          shortDescription: 'Consultation spécialisée en cardiologie',
          image: 'https://via.placeholder.com/300x200/3B82F6/FFFFFF?text=Cardiologie',
          price: 15000,
          ...
          equipment: ['Échographe', 'Électrocardiographe', 'Tensiomètre', 'Stéthoscope'],
          facilities: ['Salle d\'consultation', 'Salle d\'attente', 'Wifi', 'Climatisation'],
          requiredStaff: ['Médecin', 'Infirmier'],
          maxPatientsPerDay: 20,
          location: 'Bâtiment A, 1er étage',
          phone: '+221 33 825 45 67',
          email: 'cardiologie@clinique.com',
          website: 'www.clinique.com/cardiologie',
          onlineBooking: true,
          emergencyService: false,
          homeService: false,
          status: 'active',
        ...
        setFormData({
          ...formData,
          ...mockService,
          originalImage: mockService.image,
          imagePreview: mockService.image
        });
      ...
      <div className="mb-8">
        <div className="flex items-center mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">Mettez à jour les informations du service</p>
          </div>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                {formData.brochureFile ? formData.brochureFile.name : 'Changer le fichier'}
              </label>
            </div>
          </div>
        </div>
